...
def extract_features(home, config, opts):
  print "Extracting features."
  kb_entry = {}
  output_directory = "%s/output" % home
  entity = config.get('main','entity')
  ...
  extract_topic_features(target_directory, documents , dictionary, model, tolerance)
  # keyphrase features
...
if __name__ == "__main__":
  ...
  parser.add_option("-k", help="Update keyphrase featyres", dest='update_keyphrase_features', default=False, action='store_true')
  ...
  # Extract features
  extract_features(home, config, opts)